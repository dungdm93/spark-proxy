...
public class SparkApplication implements HasMetadata, Namespaced
{
    ...
    public SparkApplication(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, SparkApplicationSpec spec, SparkApplicationStatus status) {
        super();
